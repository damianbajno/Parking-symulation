...
public class Names_PL {
	...
	public static final String Parking_SPACE_Occupy_TENSE = "Miejsce parkingowe numer %d zostało zajęte przez Klienta %d.\n";
	public static final String THREAD_Start_TENSE = "%s zaczął pracę. \n";
	public static final String THREAD_INTERUPTED_TENSE = "ParkingManagerThread został przerwany. \n";
